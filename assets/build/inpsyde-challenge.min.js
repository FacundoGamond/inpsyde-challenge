...
/*!****************************!*\
  ...
  \****************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/api */ "./assets/js/utils/api.js");
...
class InpsydeChallenge {
  ...
  getAllUsers() {
    _utils_api__WEBPACK_IMPORTED_MODULE_0__["default"].get('inpsyde-challenge/get-all-users').then(({
      data
    }) => {
  ...
  getUserDetail(id) {
    _utils_api__WEBPACK_IMPORTED_MODULE_0__["default"].get('inpsyde-challenge/get-user-detail', {
      params: {
        id
      }
    }).then(({
...
/******/ })()
;
//# sourceMappingURL=inpsyde-challenge.min.js.map